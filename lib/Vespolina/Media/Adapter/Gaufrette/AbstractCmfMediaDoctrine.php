    ...
    MetadataSupporter
{
        ...
        $autoFlush = true)
    {
        ...
        if ($dirClass) {
            if (!is_subclass_of($dirClass, 'Media\DirectoryInterface')) {
                throw new \InvalidArgumentException(sprintf(
                    'The class "%s" does not implement Media\DirectoryInterface',
                    $dirClass
                ));
            }
    ...
    public function setMetadata($key, $metadata)
    {
        ...
        if (! $file instanceof MetadataInterface) {
            ...
            throw new \InvalidArgumentException(sprintf(
                'The class "%s" does not implement Media\MetadataInterface',
                $type
            ));
        }
